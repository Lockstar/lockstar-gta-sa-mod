...
TW_API TwBar *      TW_CALL TwNewBar(const char *barName, int iMinimized);
...
// MODMOD
TW_API int		TW_CALL TwIsBarMinimized(TwBar *bar);
TW_API int		TW_CALL TwMinimizeBar(TwBar *bar);
TW_API int		TW_CALL TwMaximizeBar(TwBar *bar);
